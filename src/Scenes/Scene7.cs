...
public class Scene7 : Scene
{
	...
	public override string Name { get; protected set; } = "Triangles";
	...
	protected override (HittableList, Camera) LoadScene()
	{
		...
		// Triangles
		world.Add(new Triangle(new(-3, -2, 5), new(0, 0, -4), new(0, 4, 0), leftRed));
		world.Add(new Triangle(new(-2, -2, 0), new(4, 0, 0), new(0, 4, 0), backGreen));
		world.Add(new Triangle(new(3, -2, 1), new(0, 0, 4), new(0, 4, 0), rightBlue));
		world.Add(new Triangle(new(-2, 3, 1), new(4, 0, 0), new(0, 0, 4), upperOrange));
		world.Add(new Triangle(new(-2, -3, 5), new(4, 0, 0), new(0, 0, -4), lowerTeal));
